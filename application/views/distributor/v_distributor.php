...
<div class="page-header">
    ...
    <div class="right">
      ...
      <div class="btn-group" role="group" aria-label="...">
        ...
        <a href="#" class="btn btn-light" data-toggle="modal" data-target="#tambah_distributor"><i class="fa fa-plus"></i>Tambah Data</a>
                                  ...
                                  <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <form method="post" class="form-horizontal" action="<?php echo base_url();?>index.php/pesanan/c_distributor/edit_data">
                                          ...
                                          <div class="form-group">                        
                                            ...
                                            <label for="Group User" class="control-label col-lg-3">Jenis Mitra</label>
                                              ...
                                              <div class="col-lg-9">
                                                  ...
                                                  <select style="width:397px" name="jenis" 
                                                     ...
                                                     <option value="<?php echo $row->jenis?>" selected><?php echo ucwords($row->jenis) ?></option>

                                                       <?php

                                                            if ($row->jenis== 'reseller') {
                                  ...
                                  <div class="modal-dialog modal-sm">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">                                   
                                          ...
                                          <b>ANDA AKAN MENGHAPUS DATA MITRA INI BESERTA CATATAN-CATATAN PEMESANANNYA</b> <br><br> Apakah anda yakin ingin menghapus data ini ?
                                      ...
                                      <div class="modal-footer">
                                        ...
                                        <a class="btn-success btn" href="<?php echo base_url();?>index.php/distributor/c_distributor/hapus_data/<?php echo $row->id; ?>">
