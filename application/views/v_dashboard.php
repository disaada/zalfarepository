...
<div class="page-header">
 ...
 <div class="row">
    ...
    <div class="col-md-12">
      ...
      <h4>JUMLAH PENJUALAN MITRA BULANAN</h4>

      <form method="post" class="form-horizontal" action="<?php echo base_url();?>index.php/c_home/lap_penjualan_mitra">
      ...
      <table id="example1" class="table display">
                    ...
                    <tbody>
                        ...
                        foreach ($penjualan_mitra->result() as $row){
                        ...
                        <tr>
                            ...
                            <!-- Modal -->
                              ...
                              <a href="<?php echo base_url();?>index.php/c_home/viewdetailproduk/<?php echo $row->id; ?>/<?php echo substr($row->tgl_pesan,5,2); ?>/<?php echo substr($row->tgl_pesan,0,4); ?>  " 

                              class='btn btn-sm btn-light' title='Lihat Detail Produk'><i class='fa fa-eye'>   Lihat Detail Produk</i></a>
