            ...
            <div class="subpage"> 
                ...
                <table class="slip">
                    ...
                    <tr>
                        ...
                        <td align="center" colspan="2">Tgl Pesan : <b><?php echo date('d M y', strtotime($pesan->tgl_pesan)); ?></b> | Ekspedisi : <b><?php echo $pesan->ekspedisi; ?></b><br><br></td>

                    </tr>

                    <tr>
                        
                        <td colspan="2"><b>Dari : </b><?php echo $pesan->dari." (".$pesan->no_mitra.")"; ?><br><br></td>
